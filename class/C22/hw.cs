        ...
        static void Main(string[] args)
        {
            ...
            .Select(s => {
                ...
                return new _country {
                    ...
                    _Estimate = Convert.ToDouble(toks[3])
                };
            })
            .GroupBy(b => b._Name)
            .Select(c =>
...
//             // ordered by "diff"
                ...
                (string t_name, double t_rate , int t_pyear, int t_cyear , double t_dif ) t = (c.Key,EstimateList[year],YearList[year-1],YearList[year],_min);
                return t ;
                // ListTuple.Add(d);
                // return new {
                //     name = c.Key ,
